  ...
  const analyzeIdea = async () => {
    ...
    try {
      const response = await fetch(
        "https://idea-forge-backend.onrender.com/api/ai/analyze",
        {
          method: "POST",
          headers: {
    ...
    <div className="container fade-in">
      ...
      >
        ...
        <p className="page-subtitle" style={{ marginBottom: "24px" }}>
          Describe your startup idea below, and our AI will evaluate it.
        </p>
        ...
        {result && (
          ...
          >
            <h3
              style={{ marginBottom: "20px", color: "var(--accent-primary)" }}
            >
              Analysis Result
            </h3>
